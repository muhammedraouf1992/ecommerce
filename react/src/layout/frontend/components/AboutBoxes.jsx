...
const AboutBoxes = () => {
    return (
        <Container className="my-5">
            <Row>
                <Col lg={2} className="">
                    <div class="feature-card p-3 card card1 ">
                        <div>
                ...
                <Col lg={2}>
                    <div class="feature-card p-3 card card2 ">
                        <div>
                ...
                <Col lg={2}>
                    <div class="feature-card p-3 card card3 ">
                        <div>
                ...
                <Col lg={2}>
                    <div class="feature-card p-3 card card4 ">
                        <div>
                ...
                <Col lg={2}>
                    <div class="feature-card p-3 card card5 ">
                        <div>
                ...
                <Col lg={2}>
                    <div class="feature-card p-3 card card6 ">
                        <div>
